    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="card-text" style="text-align: justify">
          <p>Welcome to stocknews!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of stocknews's Website, located at https://cse437s.yufeim.com/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use stocknews if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing stocknews, you agreed to
            use cookies in agreement with the stocknews's Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, stocknews and/or its licensors own the
            intellectual property rights for all material on stocknews. All
            intellectual property rights are reserved. You may access this from
            stocknews for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from stocknews</li>
            <li>Sell, rent or sub-license material from stocknews</li>
            <li>Reproduce, duplicate or copy material from stocknews</li>
            <li>Redistribute content from stocknews</li>
          </ul>
          ...
          <p>
            ...
            stocknews does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of stocknews,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, stocknews
          ...
          <p>
            stocknews reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant stocknews a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of stocknews;
          ...
          <p>
            ...
            sending an e-mail to stocknews. Please include your name, your
          ...
          <p>
            No use of stocknews's logo or other artwork will be allowed for
