                          ...
                          <div class="row m-l-0 m-r-0">
                              <div class="col-sm-4 bg-c-lite-green user-profile">
                                  <div class="card-block text-center text-white">
                                      <div class="m-b-25">
                                        <h1><FontAwesomeIcon icon="fa-user" class="me-2" /></h1>
                                      </div>
                              ...
                              <div class="col-sm-8">
                                  <div class="card-block">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-6">
                                               <p class="m-b-10 f-w-600">Verified</p>
                                               <h6 class="text-muted f-w-400">True</h6>
                                          </div>
                                      </div>
                                      <h5 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Preference</h5>
                                      <div class="row">
                                          <div class="col-sm-6">
                                              <p class="m-b-10 f-w-600">Recent</p>
                                              <h6 class="text-muted f-w-400">Economy</h6>
                                          </div>
                                      </div>
...
.bg-c-lite-green {
        background: -webkit-gradient(linear, left top, right top, from(#5d4a8b), to(#5aee66));
